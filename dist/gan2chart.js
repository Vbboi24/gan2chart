      ...
      createClass(Gan2Chart, [{
          ...
          value: function drawGrid() {
              ...
              (function () {
                  ...
                  var height = (self.option.barHeight + self.option.padding) * self._gan2TaskLength;
                  createSVG('rect', {
                      x: x,
              ...
              (function () {
                  ...
                  for (var i = 0; i < self.chartDates.length; i++) {
                      var date = self.chartDates[i];
                      var dayClass = void 0;
                      if (date.getDay() === 0) dayClass = classNames.sundayHighlight;else if (date.getDay() === 6) dayClass = classNames.saturdayHighlight;
                      // not weekend
                      if (!dayClass) continue;
                      var x = i * self.option.columnWidth;
                      var width = self.option.columnWidth;
                      var height = (self.option.barHeight + self.option.padding) * self._gan2TaskLength;
                      createSVG('rect', {
                          x: x,
          ...
          value: function bindGridClickEvent() {
              ...
              // grid click event
              $.on(this.$svg, this.option.popupTrigger, '.grid', function (e) {
                  _this3._unSelectAll();
                  _this3._hidePopup(e);
              });
          }
